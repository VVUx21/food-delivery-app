...
- Ensure amount is greater than minimum (e.g., $0.50)

## Support

- **Stripe Docs**: https://stripe.com/docs
- **React Native SDK**: https://stripe.com/docs/mobile/react-native
- **Dashboard**: https://dashboard.stripe.com

## License

This integration is part of the Food Delivery App.
